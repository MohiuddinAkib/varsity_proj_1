...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function createSystemAdmin($name, $email, $mobile_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createSystemAdmin($name, $email, $mobile_number, $password);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createHostAdmin($name, $email, $mobile_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createHostAdmin($name, $email, $mobile_number, $password);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createLocalAdmin($name, $email, $mobile_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createLocalAdmin($name, $email, $mobile_number, $password);
        }

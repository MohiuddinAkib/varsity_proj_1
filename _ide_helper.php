...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function createSystemAdmin($name, $email, $contact_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createSystemAdmin($name, $email, $contact_number, $password);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createHostAdmin($name, $email, $contact_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createHostAdmin($name, $email, $contact_number, $password);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function createLocalAdmin($name, $email, $contact_number, $password)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->createLocalAdmin($name, $email, $contact_number, $password);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function findByNameEmailContact($email)
        {
                        /** @var \App\Services\UserService $instance */
                        return $instance->findByNameEmailContact($email);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($name, $type, $location, $activity_date, $organization_id, $contact_number)
        {
                        /** @var \App\Services\SeminarService $instance */
                        return $instance->create($name, $type, $location, $activity_date, $organization_id, $contact_number);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($name, $branch, $contact_number, $owner_id, $localadmin_name = '', $localadmin_email = '', $localadmin_mobile_number = '')
        {
                        /** @var \App\Services\OrganizationService $instance */
                        return $instance->create($name, $branch, $contact_number, $owner_id, $localadmin_name, $localadmin_email, $localadmin_mobile_number);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function addEmployees($employee_data, $organization_id)
        {
                        /** @var \App\Services\OrganizationService $instance */
                        return $instance->addEmployees($employee_data, $organization_id);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($name, $type, $location, $activity_date, $organization_id, $volunteers)
        {
                        /** @var \App\Services\SocialActivityService $instance */
                        return $instance->create($name, $type, $location, $activity_date, $organization_id, $volunteers);
        }
...
namespace  { 
            ...
            class Seminar extends \App\Facades\Seminar {}
            class Organization extends \App\Facades\Organization {}
            class SocialActivity extends \App\Facades\SocialActivity {}

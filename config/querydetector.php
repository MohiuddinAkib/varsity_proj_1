...
return [
     ...
     * So if an "Author" model would have a "posts" relation that points to a "Seminar" class, you need to add both
     * the "posts" attribute and the "Seminar::class", since the relation can get resolved in multiple ways.
     */
    'except' => [
        //Author::class => [
        //    Seminar::class,
